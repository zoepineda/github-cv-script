  ...
  return (
    <>
      <main className="mx-auto max-w-[960px] px-6 py-12">
        ...
        {/* Results count */}
        <p
          className="pb-3 text-sm text-[var(--color-fg-subtle)]"
          aria-live="polite"
        >
              ...
              <div key={group.label}>
                ...
                {group.prs.map((pr) => (
                  <button
                    ...
                    className="grid w-full cursor-pointer grid-cols-[1fr_auto] gap-x-5 gap-y-1 border-b border-[var(--color-border-muted)] bg-transparent px-5 py-4 text-left transition-colors last:border-b-0 hover:bg-[var(--color-canvas-subtle)]"
                  >
                    <div className="flex flex-wrap items-baseline gap-3">
                      ...
                      <span className="font-semibold text-[var(--color-fg-default)] hover:text-[var(--color-accent-fg)]">
                        {pr.title}
                      </span>
                      <span
                      ...
                      {pr.impactSummary && (
                        <span className="rounded-full bg-[var(--color-label-green-bg)] px-1.5 py-px text-[10px] text-[var(--color-label-green-fg)]">
                          summarized
                        </span>
                      )}
                    </div>
